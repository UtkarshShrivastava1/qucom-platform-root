      ...
      <div className="mx-auto max-w-3xl px-5">
        ...
        <div className="relative mb-6">
          <div className="pr-24">
            ...
            <p className="text-[11px] text-gray-500 leading-relaxed mb-3">Please read these terms and conditions carefully before using {branding.appName}.</p>
        ...
        <div className="bg-white rounded-2xl p-5 shadow-sm border border-surface-200/50 mb-6">
          ...
          <div className="grid grid-cols-4 gap-2">
            <HighlightItem 
              ...
              desc={`By using ${branding.appName}, you agree to these terms.`} 
            />
            <HighlightItem 
        ...
        <div className="bg-white rounded-2xl p-2 shadow-sm border border-surface-200/50 mb-6">
          ...
          <div className="flex flex-col">
            <TermSection icon={<FileText className="h-4 w-4 text-[#1668F6]" />} title="1. Acceptance of Terms" desc={`By accessing or using ${branding.appName}, you agree to be bound by these Terms and Conditions.`} />
            <TermSection icon={<Info className="h-4 w-4 text-[#1668F6]" />} title={`2. About ${branding.appName}`} desc={`Learn about ${branding.appName}, our platform and the services we provide.`} />
            ...
            <TermSection icon={<ShoppingBag className="h-4 w-4 text-[#1668F6]" />} title="4. Use of Services" desc={`Guidelines for using ${branding.appName} and what you can expect from our services.`} />
            ...
            <TermSection icon={<Ban className="h-4 w-4 text-[#1668F6]" />} title="7. Prohibited Activities" desc={`Activities that are not allowed on ${branding.appName}.`} />
